...
import com.example.filedemo.Recognizer;
import com.example.filedemo.payload.ImageFileResponse;
...
public class FileController {
    ...
    @PostMapping("/bread")
    public UploadFileResponse getBread(@RequestParam("file") MultipartFile file) {
        String fileName = fileStorageService.storeFile(file);
